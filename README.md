...
**[ai4env](https://github.com/DrNikhilV/ai4env)** — ML/DL for environmental analytics: airborne heavy metal detection and satellite land-use classification.

**[ai4health](https://github.com/DrNikhilV/ai4health)** — AI disease classification suite: skin lesion analysis, MRI tumor detection, Influenza A prediction.

**[LogAnything](https://github.com/DrNikhilV/LogAnything)** — MERN stack logging platform with a Gemini AI context-aware assistant and multi-category tracking.
...
*Chennai, India · Open to collaboration on AI/ML projects*
